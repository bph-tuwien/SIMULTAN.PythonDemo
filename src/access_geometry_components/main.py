...
from access_geometry_components import *

#'test.simultan'
FILE_PATH = os.path.dirname(__file__) + '\\geometry_components.simultan'
USERNAME = 'admin'
PASSWORD = 'admin'
...
print(access_geometry_components(project, projectData))
